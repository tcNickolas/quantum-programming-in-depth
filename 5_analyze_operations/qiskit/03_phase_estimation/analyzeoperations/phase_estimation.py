...
def one_bit_phase_estimation(n, eigenvector, unitary):
  ...
  circ.h(0)
  circ.initialize(eigenvector, range(1, n + 1))
  circ.append(unitary.control(1), range(n + 1))
  circ.h(0)
  circ.measure(0, 0)
...
def two_bit_quantum_phase_estimation(n, eigenvector, unitary):
  ...
  circ.h(0)
  circ.h(1)
  circ.initialize(eigenvector, range(2, n + 2))
  circ.append(unitary.control(1), range(1, n + 2))
  circ.append(unitary.control(1), [0] + list(range(2, n + 2)))
  circ.append(unitary.control(1), [0] + list(range(2, n + 2)))
